...
$teams = $conn->query("SELECT * FROM teams ORDER BY name")->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
                    ...
                    <div class="flex gap-3">
                        <a href="teams.php?action=add"
                            ...
                            <i class="fa-solid fa-plus text-xs"></i> Add Team
                        </a>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <a href="teams.php?action=delete&id=<?= $t['id'] ?>"
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h2 class="text-xl font-bold text-gray-800">
                                    <?= $action === 'add' ? 'Add Team' : 'Edit Team' ?>
                                </h2>
                                <p class="text-sm text-gray-500 mt-0.5">
                                    <?= $action === 'add' ? 'Create a new team' : 'Update team details' ?>
                                </p>
                            </div>
                        ...
                        <form method="POST" class="space-y-4">
                            ...
                            <div class="flex items-center gap-4 pt-2">
                                <button type="submit"
                                    ...
                                    <?= $action === 'add' ? 'Create Team' : 'Update Team' ?>
                                </button>
