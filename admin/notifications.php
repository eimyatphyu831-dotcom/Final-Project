                    ...
                    <?php foreach ($notifications as $n): ?>
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition cursor-pointer notif-item"
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 rounded-full <?= $n['is_read'] == 0 ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-400' ?> flex items-center justify-center flex-shrink-0 mt-0.5">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-400 mt-2"><?= date('M j, Y \a\t g:i A', strtotime($n['created_at'])) ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
