...
<div class="min-h-screen bg-purple-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-brand-600">Select a Venue</h1>
            <p class="text-sm text-gray-500 mt-1">Choose a venue for <span class="font-semibold text-gray-700"><?= htmlspecialchars($event['event_name']) ?></span></p>
        </div>
        <a href="viewdetails.php?id=<?= $eventId ?>"
            class="inline-flex items-center gap-2 text-sm text-purple-500 hover:text-purple-700 mb-6 transition">
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                <?php foreach ($venues as $v): ?>
                    <div class="bg-white rounded-[1.5rem] shadow-sm border <?= ($selectedVenueId == $v['id']) ? 'border-purple-500 ring-2 ring-purple-200' : 'border-slate-100' ?> flex flex-col transition hover:shadow-lg hover:border-purple-200">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <div class="flex items-center gap-3 text-xs text-slate-500 mb-3">
                                <div class="flex items-center gap-1">
                                    <i data-lucide="map-pin" class="w-4 h-4 mb-3"></i>
