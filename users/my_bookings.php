                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 hover:shadow-md transition">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm text-gray-500">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span><?= htmlspecialchars($booking['venue_name']) ?>, <?= htmlspecialchars($booking['location']) ?></span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs text-gray-400 mt-1">Booked on <?= date('M j, Y', strtotime($booking['created_at'])) ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
